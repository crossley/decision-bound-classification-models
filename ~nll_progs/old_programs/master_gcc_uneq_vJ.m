...
[out_params,negloglike_gcc_uneq] = fmincon('nll_gcc_uneq_vJ',in_params,[],[],[],[],vlb,vub,[],options);
...
fprintf('BIC for GCC (Unequal Variance Case): %10.5f\n\n', BIC_gcc_uneq);
